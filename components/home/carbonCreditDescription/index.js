                ...
                <Grid templateColumns={{ base: '1fr', lg: 'repeat(2, 1fr)' }} gap={{ base: 20, lg: 40 }} my={10} mx={20} >
                    ...
                    <GridItem order={{ base: 1, lg: 2 }}>
                        <Center flexDirection={"column"} gap={6} h="full">
                            <Heading textAlign={"center"} color="primary">{t('home.carbon_credit_description.title')}</Heading>
                            <Text textAlign={"center"}>{t('home.carbon_credit_description.description')}</Text>
                            <Button color="tertiary" bg="primary" _hover={{ color: "tertiary", bg: "quaternary" }}> {t('home.carbon_credit_description.btn')}</Button>
                        </Center>
                    </GridItem>
                </Grid>
            </Box>
