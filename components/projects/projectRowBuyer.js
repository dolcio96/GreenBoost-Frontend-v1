...
import SellersTableComponent from "@components/table"
...
function ProjectRowBuyer({ project }) {
    ...
    return (<>
        ...
        >
            ...
            <Collapse mt={4} in={isOpen}>
                ...
                <SellersTableComponent tablesData={project.tablesData}/>
            </Collapse>
            <Center>
...
export default ProjectRowBuyer;
